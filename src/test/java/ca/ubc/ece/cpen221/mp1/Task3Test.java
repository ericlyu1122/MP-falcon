...
public class Task3Test {
    ...
    public void testCreateWave() throws NotFoundException {
        ...
        double[] lchannel2={0.3, 0.8, 0.5, -0.4,0.2};
        ...
        double[] rchannel3={0.8,5.0, 0.1, -0.5,0.8,1.0};
        SoundWave wave4=new SoundWave(lchannel3,rchannel3);
        double[] lchannel4={0.2, 0.7, 0.5, -0.4, 0.2};
        double[] rchannel4={0.8, 0.0, 0.2, 0.6, -1.0 };
        SoundWave wave5=new SoundWave(lchannel4,rchannel4);
        double[] lchannel5={0.4, 0.5, 0.5, -0.4, 0.2};
        double[] rchannel5={0.7, 0.1, 0.2, 0.6 };
        ...
        Set<SoundWave> kkkkk=new HashSet<>();
        kkkkk.add(wave1);
        Assert.assertEquals(kkkkk,res);
    }
